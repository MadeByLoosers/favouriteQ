...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Question.twitter_user'
        db.add_column('questions_question', 'twitter_user',
                      self.gf('django.db.models.fields.CharField')(max_length=140, null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Question.twitter_user'
        db.delete_column('questions_question', 'twitter_user')
    ...
    models = {
        ...
        'questions.question': {
            ...
            'twitter_user': ('django.db.models.fields.CharField', [], {'max_length': '140', 'null': 'True'}),
            'updated_at': ('django.db.models.fields.DateTimeField', [], {'auto_now': 'True', 'blank': 'True'})
        }
    }
